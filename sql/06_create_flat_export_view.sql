-- Create one flat reporting view for tools that only accept one CSV.
-- This joins the fact table with all dimension tables.

DROP VIEW IF EXISTS vw_full_ride_hailing_dataset;

CREATE VIEW vw_full_ride_hailing_dataset AS
SELECT
    f.trip_id,
    d.full_date,
    d.day_name,
